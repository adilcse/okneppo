...
export default function Footer() {
  return (
    <footer className="bg-black dark:bg-gray-900 text-white mt-auto py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-8 md:mb-0 flex flex-col items-center md:items-start">
            <Logo width={50} height={50} className="mb-2" />
            <h3 className="font-bold text-xl mb-2 text-[#FFF0B0] dark:text-white">Ok Neppo</h3>
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/ok.neppo/" className="text-gray-300 hover:text-primary dark:hover:text-primary">
            ...
            <a href="https://www.facebook.com/ok.neppo/" className="text-gray-300 hover:text-primary dark:hover:text-primary">
